...
public class TestMessage {
	...
	public void darvaSD99Solaris(WebDriver driver) throws InterruptedException {
		...
		*/
		...
		String name= driver.findElement(By.xpath(xpname)).getText();
		String xptype ="/html/body/div[4]/div[1]/section/div[1]/div/div[2]/div[2]/section/div/div/section/div/div[2]/div/div/div/one-record-home-flexipage2/forcegenerated-adg-rollup_component___force-generated__flexipage_-record-page___-dossier-en-cours___-case___-v-i-e-w/forcegenerated-flexipage_dossierencours_case__view_js/record_flexipage-record-page-decorator/div[1]/records-record-layout-event-broker/slot/slot/flexipage-record-home-pinned-header-left-sidebar-two-col-template-desktop2/div/div/div/one-template-workspace/navex-console-tabset2/div/navex-console-tab2[2]/section/div/div[2]/div/div/div/div/div[2]/div/div[1]/div[2]/div[2]/div[1]/div/div/table/tbody/tr[1]/td[2]/span/span";
		String type=driver.findElement(By.xpath(xptype)).getText();
		System.out.println(name+" "+type+":"+status);
	}
	
	public void darvaSD99Com (WebDriver driver, String bodymsg) throws InterruptedException {
	...
	public void darvaSD04Cont(WebDriver driver) throws InterruptedException {
		// New message
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//*[@id=\"brandBand_3\"]/div/div/div/div[1]/div[1]/div[2]/ul/li/a")).click();
	...
	public void darvaSD09Rep(WebDriver driver, String bodymsg) throws InterruptedException {
		// New message
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//*[@id=\"brandBand_3\"]/div/div/div/div[1]/div[1]/div[2]/ul/li/a")).click();
	...
	public void darvaSD18Info(WebDriver driver, String bodymsg) throws InterruptedException {
		// New message
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//*[@id=\"brandBand_3\"]/div/div/div/div[1]/div[1]/div[2]/ul/li/a")).click();
	...
	public void darvaRapport(WebDriver driver) throws InterruptedException {
	...
	public void darvaNoteHnr(WebDriver driver) throws InterruptedException {
		// New message
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//*[@id=\"brandBand_3\"]/div/div/div/div[1]/div[1]/div[2]/ul/li/a")).click();
